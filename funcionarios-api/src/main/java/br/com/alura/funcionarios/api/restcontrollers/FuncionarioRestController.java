...
public class FuncionarioRestController {
	...
	public ResponseEntity<Funcionario> cadastra(@RequestBody(required = true) Funcionario funcionario) {
		...
		try {
			...
			FuncionarioEntity funcionarioEntity = funcionarios.save(new FuncionarioEntity(funcionario.getNome(),
					funcionario.getDataNascimento(), funcionario.getSalario(), new Date()));
	...
	public ResponseEntity<Void> altera(@PathVariable Long id, @RequestBody(required = true) Funcionario funcionario) {
		...
		try {
			...
			FuncionarioEntity funcionarioEntity = funcionarios.findById(id).get();
